...
export default function ConnexionPage() {
  ...
  return (
    <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }}
      className="pt-28 min-h-screen flex items-center justify-center px-4 bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit}
          ...
          <div className="text-right">
            <Link to="/mot-de-passe-oublie" className="text-orange-500 hover:text-orange-600 text-xs font-bold">
              Mot de passe oublié ?
            </Link>
          </div>

          {error && (
            <p className="text-red-500 text-sm bg-red-50 dark:bg-red-500/10 px-4 py-2.5 rounded-xl">{error}</p>
          )}
